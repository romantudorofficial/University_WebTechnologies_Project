...
<body>
    ...
    <div class="adminContent">
        ...
        <p class="info"> If you want to add more elements, click on one of those buttons below. You can choose from 3 types of elements: question, image or content.</p>
        <p class="info"> Every lesson will start with content. Images and questions will be added later. Moreover , the images will always be placed in the center.</p>
